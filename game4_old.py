...
class Game4State:
    ...
    def initialize(self):
        ...
        self.items_phase1 = [
            ...
            {"id": 3, "type": "document", "name": "Rechnung", "color": DARK_VIOLET, "pos": [450, 330], "size": std_size, "original_category": "haushalt"},
            {"id": 4, "type": "document", "name": "Protokoll", "color": DARK_VIOLET, "pos": [200, 400], "size": std_size, "original_category": "arbeit"},
            {"id": 5, "type": "tool", "name": "Werkzeug", "color": DARK_YELLOW, "pos": [550, 200], "size": std_size, "original_category": "haushalt"},
            {"id": 6, "type": "tool", "name": "Schneider", "color": DARK_YELLOW, "pos": [350, 280], "size": std_size, "original_category": "haushalt"},
            {"id": 7, "type": "electronics", "name": "Computer", "color": DARK_VIOLET, "pos": [500, 150], "size": std_size, "original_category": "arbeit"},
            {"id": 8, "type": "electronics", "name": "Hörer", "color": CHERRY_PINK, "pos": [250, 330], "size": std_size, "original_category": "freizeit"},
            {"id": 9, "type": "food", "name": "Obst", "color": DARK_YELLOW, "pos": [400, 230], "size": std_size, "original_category": "haushalt"},
        ...
        self.items_phase2 = [
            ...
            {"id": 12, "type": "document", "name": "Anleitung", "color": DARK_VIOLET, "pos": [160, 150], "size": std_size, "original_category": "haushalt", "phase": 2},
            {"id": 13, "type": "electronics", "name": "Mobilgerät", "color": DARK_VIOLET, "pos": [360, 170], "size": std_size, "original_category": "arbeit", "phase": 2},
            {"id": 14, "type": "tool", "name": "Greifer", "color": DARK_YELLOW, "pos": [220, 220], "size": std_size, "original_category": "haushalt", "phase": 2},
    ...
    def _render_result(self):
       ...
       # if self.reset_count_phase1 > 0 or self.reset_count_phase2 > 0:
        ...
        pygame.draw.rect(self.game.screen, LIGHT_PINK, (scale_x, scale_y, fill_width, scale_height), border_radius=15)
